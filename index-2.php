       ...
       <!-- header -->
                             ...
                             <div class="col-xl-2 col-lg-2 text-right d-none d-lg-block text-right text-xl-right">
                                 <div class="header-cta">
                                    <ul>
                                        ...
                                        <li>
                                           <a href="#"><i class="fa-thin fa-user"></i> Sign In</a>
                                        </li>
                                         <li>
                                           <a href="#"><i class="fa-thin fa-cart-shopping"></i> My Cart</a>
                                        </li>
                                    </ul>
                                 </div>                              
                            </div>
        ...
        <main>
              <section id="parallax" class="slider-area slider-two fix p-relative">
				...
				<div class="single-slider slider-bg2 d-flex align-items-center" style="background: url(img/slider/slider2.png) no-repeat; background-position: center center;">
                        <div class="container">
                           <div class="row justify-content-center align-items-center">
                                <div class="col-lg-6 col-md-6">
                                    <div class="slider-content s-slider-content2">
                                       <h2 data-animation="fadeInUp" data-delay=".4s">Smart Digital Creative Web Agency</h2>
                                        <p data-animation="fadeInUp" data-delay=".6s">Nulla lobortis orci vel rutrum cursus. Curabitur at hendrerit libero. Curabitur bibendum eros nec augue egestas facilisis. Duis sit amet aliquet arcu, sit amet fermentum lectus.</p>
                                        
                                         <div class="slider-btn mt-30">                                          
                                            <a href="about.html" class="btn mr-15" data-animation="fadeInUp" data-delay=".4s">Explore More <i class="fa-sharp fa-light fa-arrow-up"></i></a>                                             
                                        </div>        
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                           <div class="s-single-services s-single-services2 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                               <a href="single-service.html" class="icon-plus"><i class="fa-light fa-plus"></i></a>
                            <div class="services-icon">
                               <img src="img/icon/sr-icon5.png" alt="icon"/>
                                <img src="img/icon/sr-icon5-hover.png" alt="img" class="hover">
                            </div>
                            <div class="second-services-content">
                               ...
                               <div class="sr-h-bg">
                               <img src="img/bg/sr-h-bg2.png" alt="icon"/>
                            </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                         <div class="s-single-services s-single-services2 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                              <a href="single-service.html" class="icon-plus"><i class="fa-light fa-plus"></i></a>
                            <div class="services-icon">
                               <img src="img/icon/sr-icon6.png" alt="icon"/>
                                <img src="img/icon/sr-icon6-hover.png" alt="img" class="hover">
                            </div>
                            <div class="second-services-content">
                          ...
                          <div class="s-single-services s-single-services2 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                            ...
                            <div class="services-icon">
                               <img src="img/icon/sr-icon7.png" alt="icon"/>
                                <img src="img/icon/sr-icon7-hover.png" alt="img" class="hover">
                            </div>
                            <div class="second-services-content">
                           ...
                           <div class="s-single-services s-single-services2 mb-30 wow fadeInUp animated" data-animation="fadeInDown animated" data-delay=".2s">
                            ...
                            <div class="services-icon">
                               <img src="img/icon/sr-icon8.png" alt="icon"/>
                                <img src="img/icon/sr-icon8-hover.png" alt="img" class="hover">
                            </div>
                            <div class="second-services-content">
           ...
           <!-- services-three-area -->
             <!-- about-area -->
            <section id="about" class="about-area about-p pb-120 p-relative fix">
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="about-content s-about-content wow fadeInRight  animated" data-animation="fadeInRight" data-delay=".4s">
                                <div class="about-title second-title pb-25">  
                                    ...
                                    <h2>We Create Websites for All Creative Agency.</h2>                                   
                                </div>                                   
					...
					<div class="portfolio ">
                        ...
                        <div class="portfolio-active wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s">
                            ...
                            <div class="grid-item family">
                                    <a href="single-protfolio.html">
                                    <figure class="gallery-image">
                                        <img src="img/gallery/protfolio-img09.png" alt="img" class="img">
                                        <figcaption>
                                            <div class="date-home">
                                               21 Aug 2023
                                            </div>
            ...
            <!-- pricing-area-end -->     
              <!-- counter-area -->
            <div class="counter-area p-relative pt-120 pb-120" style="background: url(img/bg/price-bg.png) no-repeat; background-position: center center;">
                <div class="container">
           ...
           <!-- faq-area -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                       <div class="col-lg-4 col-md-6">
                            <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="blog-details.html"><img src="img/blog/blog-tumb01.png" alt="img"></a>
                                ...
                                <div class="blog-content2">
                                   ...
                                   <div class="b-cat">
                                    ...
                                    <p>Nulla pulvinar, pharetra imperdiet, risue sagittis lacus, ut egestas dui neque nec risus.</p>
                                   <div class="b-meta">
                                        <div class="meta-info">
                                            <ul>
                                                <li><i class="fal fa-user"></i> by Noile Mohsin</li>
                                                <li><a href="#" class="btn">Read More <i class="fa-sharp fa-light fa-arrow-up"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                         ...
                         <div class="col-lg-4 col-md-6">
                            <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="blog-details.html"><img src="img/blog/blog-tumb02.png" alt="img"></a>
                       ...
                       <div class="col-lg-4 col-md-6">
                            <div class="single-post2 hover-zoomin mb-30 wow fadeInUp animated" data-animation="fadeInUp" data-delay=".4s">
                                <div class="blog-thumb2">
                                    <a href="blog-details.html"><img src="img/blog/blog-tumb03.png" alt="img"></a>
            ...
            <section class="cta-area cta-bg" >
                <div class="container pt-60 pb-60 pl-60 pr-60" style="background-image:url(img/bg/cta_bg02.png); background-repeat: no-repeat; background-size: cover; background-position: center center;">
